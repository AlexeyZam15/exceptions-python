...
# В методе printSum незачем кидать исключение FileNotFoundException, и сама функция бесполезная, т.к. просто
# складывает 2 целых числа

# int[] abc = {1, 2}
# abc[3] = 9 объявлено только 2 элемента, а вызывается 3-й по индексу, элементов должно быть 4
